...
## What It Does
**Document Panel (left sidebar)**: Here, you can upload one or more PDF telemetry logs. Then OrbitLens extracts the text automatically and lists it in a sidebar. You can click any document to make it active, and the dashboard and chat will use it as context.
...
**AI Chat (right panel)**: Can ask questions about the loaded documents in plain language. You can switch between two agent modes:
...
## Tech Stack
PDF.js, Chart.js, Tone.js, marked.js, Google Gemini API, Google Fonts
