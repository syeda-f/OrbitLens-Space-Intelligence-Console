...
## What It Does
**Document Panel (left sidebar)**: Here can upload one or more PDF telemetry logs. OrbitLens extracts the text automatically and lists it in a sidebar. Click any document to make it the active one, and the dashboard and chat will use it as context.
...
**Ambient Audio**: Three synthesized soundscapes that you can toggle on/off: Deep Space, Nebula Hum, and Pulse Grid.
